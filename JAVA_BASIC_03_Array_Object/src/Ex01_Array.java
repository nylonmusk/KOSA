...
public class Ex01_Array {
	public static void main(String[] args) {
		...
		// 방의 개수는 항상 index 값다 1이 크다 (n - 1 마지막 index)
		...
		int[] arr3= {11,22,33}; // 컴파일러가 알아서 new 처리 .... 부탁 
		//Tip)  const arr = [1,2,3,4,5];  let arr= [100,200];   let arr=[]  arr.push("")
		//javascript 는 동적배열 입니다 ^^
